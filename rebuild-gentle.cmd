...
start /B /WAIT /AFFINITY FFFFFF00 /BELOWNORMAL "" powershell -NoProfile -ExecutionPolicy Bypass -File C:\TabsPortalHelper\Rebuild.ps1 > "%TEMP%\helper-rebuild.txt" 2>&1
set RC=%errorlevel%
