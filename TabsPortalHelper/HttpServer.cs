...
namespace TabsPortalHelper
{
    class HttpServer
    {
        ...
        void HandleOpen(HttpListenerContext ctx, System.Collections.Specialized.NameValueCollection query)
        {
            ...
            ActiveFileTracker.SetLastFile(filePath);
        ...
        {
            public string? Note     { get; set; }   // BSI[0]
            public string? Status   { get; set; }   // BSI[1]
            public string? Element  { get; set; }   // BSI[2]
            public string? Location { get; set; }   // BSI[3]
            public string? Issue    { get; set; }   // BSI[4]
